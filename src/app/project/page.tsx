      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 px-3 lg:px-5">
          {projects.map((project, index) => (
            <Link key={index} href={`/project/${project.id}`} rel="noopener noreferrer" className="border border-gray-700 hover:bg-gray-950 lg:hover:scale-105 transition duration-200 rounded-lg overflow-hidden shadow-lg">
