  ...
  return (
    <section id="home" className="text-gray-300 text-center flex lg:flex-row flex-col lg:justify-between gap-20 lg:mt-0 lg:gap-0 justify-start items-center lg:w-[900px] xl:w-[1100px] w-full mx-auto lg:h-[88vh]">
      <div className="container lg:w-[500px] w-full px-8 lg:p-0">
        ...
        <p className="my-6 lg:text-xl text-md text-start">I am a person with strong skills and interests in web and mobile development. I am a responsible person and always ready to face new challenges. With a high spirit of learning, I am committed to giving the best contribution in every project that is worked on.</p>
